        ...
        <div id="wrapper">
            <div id="header">
                ...
                <div class="menu">
                    ...
                    <a class="link-1" id="sign" href="#">Đăng Nhập</a>
                    <a class="link-3" href="quanly.jsp">Quản Lý</a>
                </nav>
                </div>
            </div>
            <div id="content">
                <div id="Qdangxuat">Bạn có muốn đăng xuất???</div>
                <br/>
                <form action="CtlAccount">
                    <input type="submit" id="btncoDX" onclick="delsign()" name="action" value="Có"/>
                    <a href="index.jsp"><input id="btnkhongDX" type="button" value="Không"/></a>
                </form>
            </div>
            <div id="footer">
