 ...
 */
public class UpLoadImgSanPham extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         if(ServletFileUpload.isMultipartContent(request)){
            final String UPLOAD_DIRECTORY = getDirectoryProject()+"web\\images\\Products"; //Đường dẫn lưu
            String url ="";
